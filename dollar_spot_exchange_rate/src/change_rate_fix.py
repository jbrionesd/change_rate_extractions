...
try:
    response = requests.get('https://www.banxico.org.mx/SieAPIRest/service/v1/series/SF43718/datos', 
    headers={
    ...
    csv_writer =  csv.writer(open(r"//192.168.1.38/2. DATOS FUENTE/BI/Extracciones Web/exchange_rate_fix.csv", "w"), delimiter=",", lineterminator='\n')
